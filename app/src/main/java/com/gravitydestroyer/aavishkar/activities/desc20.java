...
public class desc20 extends AppCompatActivity {

    public void phoneopen(View view){
        String phone = "8145386516";
    ...
    public static String FACEBOOK_URL = "https://www.facebook.com/events/1785242234861850/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desc20);
