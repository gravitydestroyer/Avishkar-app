...
public class odesc8 extends AppCompatActivity {

    public void phoneopen(View view){
        String phone = "+919674825450";
    ...
    public static String FACEBOOK_URL = "https://www.facebook.com/events/1417644645008517/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_odesc8);
