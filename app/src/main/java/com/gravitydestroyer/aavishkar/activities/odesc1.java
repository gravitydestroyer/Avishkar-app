...
public class odesc1 extends AppCompatActivity {
    ...
    public void urlopen(View v) {
        ...
        intent.setData(Uri.parse("https://freepl.nitdgplug.org/"));
        startActivity(intent);
    }
    ...
    public static String FACEBOOK_URL = "https://www.facebook.com/events/202429953858184/";
