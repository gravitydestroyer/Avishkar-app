...
public class desc17 extends AppCompatActivity {

    public void phoneopen(View view){
        String phone = "+919800784681";
    ...
    public static String FACEBOOK_URL = "https://www.facebook.com/events/172416380050175/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desc17);
