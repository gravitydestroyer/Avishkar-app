...
public class odesc5 extends AppCompatActivity {

    public void phoneopen(View view){
        String phone = "+918240129567";
    ...
    public static String FACEBOOK_URL = "https://www.facebook.com/events/172628736695991/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_odesc5);
        setTitle("Freemex");
    }
}
