...
public class odesc2 extends AppCompatActivity {
    ...
    public void urlopen(View v) {
        ...
        intent.setData(Uri.parse("https://saenitd.com/"));
        startActivity(intent);
    }
    ...
    public static String FACEBOOK_URL = "https://www.facebook.com/events/174142406708060/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_odesc2);
        setTitle("Bid Wars");
    }
}