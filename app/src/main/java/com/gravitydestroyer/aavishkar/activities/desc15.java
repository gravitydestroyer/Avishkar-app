...
public class desc15 extends AppCompatActivity {

    public void phoneopen(View view){
        String phone = "+918583826369";
    ...
    public static String FACEBOOK_URL = "https://www.facebook.com/events/272660863268166/";
    public static String FACEBOOK_PAGE_ID = "aavishkar.nitd";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_desc15);
        setTitle("Lipi");
    }
}