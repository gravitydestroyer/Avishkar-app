...
public class desc22 extends AppCompatActivity {

    public void phoneopen(View view){
        String phone = "9674598150";
    ...
    public static String FACEBOOK_URL = "https://www.facebook.com/events/1901663159876132/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desc22);
        setTitle("AutoLocked");
    }
}