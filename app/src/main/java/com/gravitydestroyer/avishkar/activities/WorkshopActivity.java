...
public class WorkshopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Event> WEventList = getListItemData();
        List<Descript> WDescriptList = getListItemsData();

        WorkshopAdapter adapter = new WorkshopAdapter(WorkshopActivity.this, WEventList,WDescriptList);
    ...
    private List<Event> getListItemData(){
        ...
        listViewItems.add(new Event("Workshop1"));
        listViewItems.add(new Event("Workshop2"));
        listViewItems.add(new Event("Workshop3"));
        listViewItems.add(new Event("Workshop4"));
        listViewItems.add(new Event("Workshop5"));
